...
public class StringTool {
	...
	public static boolean isFemale(final String name){
		...
		final String[] suffices = {
			"a", "is", "ys", "e", "ei", "ey", "id", "it", "ah", "eh", "th"
		};
	...
	/**
	 * Parse an int String but don't throw exception if not parsable. Return 0 instead
	 * 
	 * @param string
	 * @return
	 */
	 ...
	 * klammern. Note: Es gibt inzwischen eine Java StringTokenizer.
	 * 
	 * @author Gerry Weirich
	 * 
	 */
