/*******************************************************************************
 * Copyright (c) 2017-2018, G. Weirich and Elexis
...
public class Blob {
	 ...
	 * 
	 * This is a Plug-In replacement for {@link PersistentObject#fold(byte[])}
	 * 
	 * @param flat
	 * @return The originally flattend object
	 * @since 3.1
	 */
	...
	/**
	 * This is a Plug-In replacement for {@link PersistentObject#flattenObject(Object)}
	 * ungrad: Store as hashtable and as json
	
	 * @param object
	 * @return a byte array which is a zip containing the object as flattened Hashtable and as flattened JsonObject
	 */
