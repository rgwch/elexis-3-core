...
public class BriefDocumentDTO extends AbstractDocumentDTO {
	...
	public BriefDocumentDTO(Brief brief, String storeId) {
		...
		String[] fetch = new String[] { Brief.FLD_PATIENT_ID, Brief.FLD_SENDER_ID, Brief.FLD_NOTE, Brief.FLD_SUBJECT,
		...
		if (StringUtils.isNotEmpty(data[5])) {
			...
			if (kontakt != null) {
				getHistory().add(new HistoryDocumentDTO(getLastchanged(), DocumentStatus.SENT, kontakt.getLabel()));
			}
		}
