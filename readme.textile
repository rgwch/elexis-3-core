...
* Consultations can be ordered by creation time, not only by date. (since the necessity to create more than one consultation entry per day increased with the latest tarmed revision) (planned)
