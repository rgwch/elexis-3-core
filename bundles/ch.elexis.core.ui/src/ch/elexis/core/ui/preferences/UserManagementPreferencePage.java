...
public class UserManagementPreferencePage extends PreferencePage implements IWorkbenchPreferencePage, IUnlockable {
	...
	public Control createContents(Composite parent) {
		...
		if (!(Status.STANDALONE == CoreHub.getLocalLockService().getStatus())) {
			...
			btnLock.setSelection(CoreHub.getLocalLockService().isLocked((IPersistentObject) wvUser.getValue()));
			...
			btnLock.addSelectionListener(new SelectionAdapter() {
				...
				public void widgetSelected(SelectionEvent e) {
					...
					boolean locked = CoreHub.getLocalLockService().isLocked((IPersistentObject) wvUser.getValue());
